...
aven_buffs = {
  "base": [duran, aria, tonal, unjust, leverage(aven["defe"]), unjust_debuff],
...
aven_first_buffs = {
  "base": [duran, aria, tonal, unjust, leverage(aven["defe"] + 0.6 * aven["base_defe"]), red_or_black, unjust_debuff],
  "fua": [duran_fua, proof, duke_2],
  "concerto": [concerto],
  "concerto_fua": [flourish],
}
