...
robin_buffs = {
  "base": [fleet, unjust_debuff],
  "ult": [journey],
  "concerto": [concerto]
}

feixiao_buffs = {
  "base": [thunderhunt, boltcatch, duran, aria, tonal, fleet, unjust_debuff],
...
topaz_buffs = {
  "base": [duran, duran_fua, proof, swordplay, duke_2, duke_4, aria, tonal, fleet, unjust_debuff],
  "fua": [],
  "concerto": [concerto],
  "concerto_fua": [flourish],
...
salsotta_cond = {
  "all_type_dmg_mult": 15
}

aven_buffs = {
  "base": [salsotta_base, aria, tonal, unjust, leverage(aven["defe"]), unjust_debuff],
  "fua": [salsotta_cond, proof, duke_2],
  "concerto": [concerto],
  "ult": [salsotta_cond],
  "concerto_fua": [flourish],
}
...
aven_first_buffs = {
  "base": [salsotta_base, aria, tonal, unjust, leverage(aven["defe"] + 0.6 * aven["base_defe"]), red_or_black, unjust_debuff],
  "fua": [proof, duke_2],
  "concerto": [concerto],
  "ult": [salsotta_cond],
  "concerto_fua": [flourish],
