...
feixiao_buffs["fua"] += [worrisome]
feixiao_buffs["concerto_ult"] += [worrisome]
feixiao_buffs["base"] += [tame]
topaz_buffs["base"] += [tame]
aven_first_buffs["base"] += [tame]
aven_buffs["base"] += [tame]
