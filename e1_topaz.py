...
feixiao_buffs["fua"]+= [future_market]
feixiao_buffs["concerto_ult"] += [future_market]
topaz_buffs["base"] += [future_market]
aven_buffs["fua"] += [future_market]
aven_first_buffs["fua"] += [future_market]
